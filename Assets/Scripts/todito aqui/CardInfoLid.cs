...
public class CardInfoL : MonoBehaviour
{
    ...
    {
        InfoText.text =
        Card.GetComponent<CartasdeLider>().Name + ". LÍDER DE FACCIÓN. DESCRIPCIÓN: "  + Card.GetComponent<CartasdeLider>().DescriptionEffect + ". FACCIÓN: "+ Card.GetComponent<CartasdeLider>().Faction;
